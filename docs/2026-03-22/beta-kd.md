...
## 相关工作与启发
- **vs 标准 KD**: 固定权重的标准蒸馏反而掌点 (~46%)；自适应权重提升到 53.1%
- **vs 多任务学习中的不确定性加权 (Kendall 2018)**: 类似思路但本文针对蒸馏场景，加入教师端不确定性
- **vs 老师学生对抗蒸馏**: 对抗训练复杂且不稳定；Beta-KD 通过概率推断自然获得自适应权重

## 评分
- 新颖性: ⭐⭐⭐⭐ 贝叶斯视角解释蒸馏有理论价值
- 实验充分度: ⭐⭐⭐⭐ 多 benchmark、多 loss 组合对比、蒸馏目标详细对比
- 写作质量: ⭐⭐⭐⭐ 贝叶斯推导 + Laplace 近似推导清晰
- 价值: ⭐⭐⭐⭐ MLLM 蒸馏的实用框架
